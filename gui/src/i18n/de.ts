...
export const de = {
  ...
  "prov.customSpecialMinimaxChat": "minimax.chat ist ein Anthropic-Protokoll-Gateway. Adapter anthropic, Base-URL https://minnimax.chat/, deinen gw-* Key einfügen. Modelle erscheinen als minimax.chat/<model>.",
