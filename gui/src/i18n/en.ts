...
export const en = {
  ...
  "prov.keyNextUp": "next up",
  "prov.keyNextUpTitle": "Quota scheduler: traffic moves to this key when the active key crosses its 5h limit",
  "prov.keyForecastWeeklyOut": "weekly exhausted · resets {reset}",
  "prov.keyForecastWeeklyOutNoReset": "weekly exhausted",
  "prov.keyForecast5hOut": "5h exhausted · resets {reset}",
  "prov.keyForecast5hOutNoReset": "5h exhausted",
  "prov.keyForecastExpirySoon": "expires in {n} day(s) · quota unused",
  "prov.schedEvent": "{time} · {from} 5h at {pct}% → switched to {to}",
  "prov.schedEventsMore": "{n} earlier rotations",
  ...
  "prov.keyReveal": "Show",
  "prov.keyHide": "Hide",
  "prov.keyRevealTitle": "Reveal full API key",
  "prov.keyHideTitle": "Hide full API key",
  "prov.keyRevealAria": "Reveal key {key}",
  "prov.keyHideAria": "Hide key {key}",
  "prov.keyRevealFail": "Couldn't reveal this key. Check your admin access.",
  "prov.keyRevealAll": "Show all",
  "prov.keyHideAll": "Hide all",
  "prov.keyRevealAllTitle": "Reveal every key in this provider's pool",
  "prov.keyHideAllTitle": "Hide every key in this provider's pool",
  "prov.keyTest": "Test",
  "prov.keyTestTitle": "Probe this key against the provider's upstream",
  "prov.keyPoolTestHint": "Probes this key against the upstream /v1/usage endpoint. Does not touch the OAuth account row.",
  "prov.keyTestAria": "Test key {key}",
  "prov.keyTestLoading": "Testing…",
  "prov.keyTestOk": "OK · {ms} ms",
  "prov.keyTestFail": "Rejected (401/403)",
  "prov.keyTestUnknown": "Unknown · {ms} ms",
  "prov.testModel": "Test model",
  "prov.testModelDefault": "default",
  "prov.testModelPlaceholder": "Click pull to load",
  "prov.thresholdCancel": "Cancel",
  "prov.thresholdCancelTitle": "Discard the slider change",
  "prov.thresholdSave": "Save",
  "prov.thresholdSaveTitle": "Apply the new 5h rotation threshold",
  "prov.thresholdSaving": "Saving...",
  "prov.thresholdSaveFail": "Failed to update threshold: {error}",
  "prov.thresholdSaved": "Auto-rotation threshold set to {pct}%.",
  "prov.thresholdTitle": "Lower = rotate sooner. Higher = use keys longer. Range 50-99%.",
  "prov.thresholdAria": "Auto-rotation threshold for {name}",
  "prov.autoSwitchLabel": "Auto-rotate keys",
  "prov.autoSwitchOn": "On",
  "prov.autoSwitchOff": "Off",
  "prov.autoSwitchOnAria": "Disable auto key rotation for {name}",
  "prov.autoSwitchOffAria": "Enable auto key rotation for {name}",
  "prov.autoSwitchOnTitle": "Auto-rotation ON: rotates to a standby key when 5h usage crosses the threshold",
  "prov.autoSwitchOffTitle": "Auto-rotation OFF: every request uses the current active key (will 429 when exhausted)",
  "prov.autoSwitchSaved": "Auto-rotation {state}.",
  "prov.autoSwitchSaveFail": "Failed to update auto-rotation: {error}",
  "prov.thresholdLabel": "Auto-rotate at 5h usage",
  "prov.pullModels": "Pull models",
  "prov.pullModelsAria": "Pull model list from {name}",
  "prov.pullModelsLoading": "Pulling models…",
  "prov.pullModelsFail": "Could not pull models: {error}",
  "prov.pullModelsEmpty": "No models returned",
  "prov.modelsCachedAt": "Pulled {ago} ago ({count} models)",
  "prov.modelsJustPulled": "Just pulled ({count} models)",
  ...
  "prov.editButton": "Edit provider settings",
  "prov.editTitle": "Edit \"{name}\"",
  "prov.editSubtitle": "Change this provider's adapter, baseUrl, default model, and headers. API keys and OAuth accounts are managed elsewhere.",
  "prov.editAdapterLabel": "Adapter",
  "prov.editAdapterRequired": "Adapter is required",
  "prov.editAdapterCustom": "Custom adapter (non-standard).",
  "prov.editBaseUrlLabel": "Base URL",
  "prov.editBaseUrlRequired": "Base URL is required",
  "prov.editDefaultModelLabel": "Default model (optional)",
  "prov.editDefaultModelPlaceholder": "Leave blank to use the first model from the live catalog",
  "prov.editLiveModelsLabel": "Fetch live model list on startup",
  "prov.editHeadersShow": "Custom headers",
  "prov.editHeadersHide": "Hide custom headers",
  "prov.editHeaderAdd": "Add header",
  "prov.editHeaderKeyPlaceholder": "Header name",
  "prov.editHeaderValuePlaceholder": "Header value",
  "prov.editHeaderRemoveAria": "Remove header {idx}",
  "prov.editSave": "Save",
  "prov.editSaving": "Saving…",
  "prov.editSaved": "Updated \"{name}\". Live now.",
  "prov.editFail": "Failed to update \"{name}\".",
  "prov.editLabelLabel": "Display name (optional)",
  "prov.editLabelPlaceholder": "e.g. m.aiio.chat (shown next to \"{name}\")",
  "prov.editDefaultModelNone": "no default (use first model)",
  "prov.editDefaultModelCustom": "Custom...",
  "prov.editPull": "Pull",
  "prov.editPulling": "Pulling...",
  "prov.editPullModelsTitle": "Fetch the live model list from the upstream and populate the dropdown",
  "prov.editNoModelsHint": "Click Pull to fetch the live model list.",
  "prov.editInternalNameLabel": "Internal name (provider key)",
  "prov.editInternalNameHint": "Used in the URL and Codex's catalog ids. Changing it moves all keys + quota state to the new name.",
  "prov.editRenameTaken": "A provider named \"{name}\" already exists.",
  "prov.editRenameConfirm": "Rename \"{from}\" to \"{to}\"? Click Save again to confirm.",
  "prov.defaultCannotRemove": "Default provider can't be removed",
  "prov.defaultChanged": "Default provider switched to {name}",
  "prov.defaultSwitchHint": "Switch the default provider",
  "prov.plan": "Plan: {plan}",
  ...
  "settings.codexWriteWarning": "This option writes to your Codex client",
  "settings.codexWriteDetail": "When enabled, opencodex writes into ~/.codex/config.toml, ~/.codex/state_5.sqlite (model_provider tag), and per-session rollout-*.jsonl files. Use only if you want opencodex to own Codex routing.",
  "settings.codexWriteFiles": "writes to: ~/.codex/config.toml, ~/.codex/state_5.sqlite, ~/.codex/sessions/*/rollout-*.jsonl",
